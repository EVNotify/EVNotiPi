    ...
    def getData(self):
        ...
        if set([0x7EC21,0x7EC22,0x7EC23]).issubset(raw[2101]) and \
            ...
            data['EXTENDED'] = {
                    ...
                    'charging':                 1 if chargingBits != None and chargingBits & 0x80 == 0x80 else 0,
                    'normalChargePort':         1 if chargingBits != None and chargingBits & 0x20 == 0x20 else 0,
                    'rapidChargePort':          1 if chargingBits != None and chargingBits & 0x40 == 0x40 else 0,
